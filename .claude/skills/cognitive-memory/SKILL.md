...
```bash
python3 /home/user/.memory/memory_ops.py recall "" --scope /recipes/allrecipes --limit 10
python3 /home/user/.memory/memory_ops.py tree /recipes/allrecipes
```
...
python3 /home/user/.memory/memory_ops.py remember "FACT" \
  --scope /recipes/allrecipes/DOMAIN \
...
```bash
python3 /home/user/.memory/memory_ops.py recall "QUERY" --scope /recipes/allrecipes
```
...
```bash
python3 /home/user/.memory/memory_ops.py forget --scope /recipes/allrecipes --older-than 90 --dry-run
python3 /home/user/.memory/memory_ops.py forget --scope /recipes/allrecipes --older-than 90
```
