...
```bash
python3 /home/user/.memory/memory_ops.py recall "" --scope /allrecipes --limit 10
python3 /home/user/.memory/memory_ops.py tree /allrecipes
```
...
```bash
python3 /home/user/.memory/memory_ops.py recall "QUERY" --scope /allrecipes
```
...
```bash
python3 /home/user/.memory/memory_ops.py forget --scope /allrecipes --older-than 90 --dry-run
python3 /home/user/.memory/memory_ops.py forget --scope /allrecipes --older-than 90
```
