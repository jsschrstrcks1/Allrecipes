...
```bash
node /Users/kenbaker/atlas-serve/admin/library.mjs preflight --query "<task>" --patron <you> --merge --repo Allrecipes
```

| File | Role |
|------|------|
| `admin/UNFINISHED_TASKS.md` / `PENDING_TASKS.md` | Open mirror |
